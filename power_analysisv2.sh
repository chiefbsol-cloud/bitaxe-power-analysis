...
# Power Analysis Tool v2 - displays Pool Difficulty
...
collect_data() {
  ...
  for field in HOSTNAME BOARD_POWER HASH_RATE ASIC_TEMP VREG_TEMP FAN_SPEED_PERCENT FREQUENCY CORE_VOLTAGE UPTIME_TOTAL_SECONDS SHARES_ACCEPTED SHARES_REJECTED BEST_DIFF BEST_SESSION_DIFF FAN_RPM POOL_NAME STRATUM_DIFF FALLBACK_POOL_NAME IS_USING_FALLBACK; do
...
🏊 Pool:            $POOL_NAME_ESC
📊 Stratum Diff:   $(printf "%5.0f" "$STRATUM_DIFF")
</pre>
🕒 <b>Time:</b> $TIME_NOW
📅 <b>Date:</b> $DATE_NOW
EOF
