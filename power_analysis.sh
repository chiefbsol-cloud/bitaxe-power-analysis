...
MinerIPAddress1=YOUR MINER IP  # IP address of miner 1 or NULL
...
ATTACH_POWER_ANALYSIS_LOG="YES"      # Attach power_analysis.log
...
collect_data() {
  ...
  for field in HOSTNAME BOARD_POWER HASH_RATE ASIC_TEMP VREG_TEMP FAN_SPEED_PERCENT FREQUENCY CORE_VOLTAGE UPTIME_TOTAL_SECONDS SHARES_ACCEPTED SHARES_REJECTED BEST_DIFF BEST_SESSION_DIFF FAN_RPM; do
